                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing New AI-Ready Features</span>
                                ...
                                <TextEffect
                                    ...
                                    Looped organizes conversations into channels with threads, is realtime, and uses AI to keep teams in sync.
                                </TextEffect>
