...
export function MessageList() {
  ...
  const inifiniteOptions = orpc.message.list.infiniteOptions({
...
<EmptyState title='No Messages' description=" Start the conversation by sending the first message" buttonText="Send a Message" href="#" />
  ...
  items?.map((message) =>(
    <MessageItem key={message.id} message={message} currentUserId={user.id}/>
      ...
      {isFetchingNextPage && (
        <div className="pointer-events-none gap-2 rounded-md bg-gradient">
